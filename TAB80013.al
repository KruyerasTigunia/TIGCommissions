table 80013 "Comm. Recognition Entry"
{
    // version TIGCOMM1.0

    // TIGCOMM1.0 Commissions

    DrillDownPageID = "Comm. Recognition Entries";
    LookupPageID = "Comm. Recognition Entries";
    ...
    fields
    {
        ...
        {
            CalcFormula = Sum("Comm. Approval Entry"."Basis Qty. Approved" WHERE ("Comm. Recog. Entry No."=FIELD("Entry No.")));
            DecimalPlaces = 0:2;
            Editable = false;
        ...
        {
            CalcFormula = Min("Comm. Payment Entry".Quantity WHERE ("Comm. Recog. Entry No."=FIELD("Entry No.")));
            DecimalPlaces = 0:2;
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Sum("Comm. Approval Entry"."Qty. Remaining to Pay" WHERE ("Comm. Recog. Entry No."=FIELD("Entry No.")));
            DecimalPlaces = 0:2;
            Description = 'DEPR';
            Editable = false;
            FieldClass = FlowField;
        ...
        {
            CalcFormula = Sum("Comm. Approval Entry"."Basis Amt. Approved" WHERE ("Comm. Recog. Entry No."=FIELD("Entry No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(160;"Basis Amt. Paid";Decimal)
        {
            CalcFormula = Sum("Comm. Payment Entry".Amount WHERE ("Comm. Recog. Entry No."=FIELD("Entry No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(170;"Basis Amt. Remaining";Decimal)
        {
            CalcFormula = Sum("Comm. Approval Entry"."Amt. Remaining to Pay" WHERE ("Comm. Recog. Entry No."=FIELD("Entry No.")));
            Description = 'DEPR';
            Editable = false;
            FieldClass = FlowField;
        }
