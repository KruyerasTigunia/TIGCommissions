    ...
    fields
    {
        ...
        field(50;"Source Method";Option)
        {
            ...
            begin
                ...
                case "Source Method" of
                  "Source Method"::All : "Source Method Sort" := 0;
                  "Source Method"::Group : "Source Method Sort" := -1;
                  "Source Method"::Specific : "Source Method Sort" := -2
                end;
            end;
        }
        field(60;"Source Method Code";Code[20])
        {
            TableRelation = IF ("Source Type"=CONST(Customer),
                                ...
                                ELSE IF ("Source Type"=CONST(Customer),
                                         "Source Method"=CONST(Group)) "Commission Customer Group".Code
                                         ELSE IF ("Source Type"=CONST(Vendor),
                                                  "Source Method"=CONST(Specific)) Vendor."No."
                                                  ELSE IF ("Source Type"=CONST(Vendor),
                                                           "Source Method"=CONST(Group)) "Commission Vendor Group".Code;
        }
        ...
        field(90;"Unit Method Code";Code[20])
        {
            TableRelation = IF ("Unit Type"=CONST("G/L Account"),
                                ...
                                ELSE IF ("Unit Type"=CONST(Item),
                                         "Unit Method"=CONST(Specific)) Item."No."
                                         ELSE IF ("Unit Type"=CONST(Resource),
                                                  "Unit Method"=CONST(Specific)) Resource."No."
                                                  ELSE IF ("Unit Method"=CONST(Group)) "Commission Unit Group".Code;
        }
