codeunit 80003 "Create Comm. Entries From Hist"
{
    // version TIGCOMM1.0
        ...
        if SalesShptLine.FINDSET then begin
          repeat
            ...
            case CheckTriggers(TriggerMethod::Shipment,CommPlanCode,SalesShptLine.Type) of
              'NOCUSTPLAN' : ERROR(Text013,SalesShptLine."Sell-to Customer No.");
              'NOITEMPLAN' : ERROR(Text014,
        ...
        if SalesInvLine.FINDSET then begin
          repeat
            ...
            case CheckTriggers(TriggerMethod::Invoice,CommPlanCode,SalesInvLine.Type) of
              'NOCUSTPLAN' : ERROR(Text013,SalesInvLine."Sell-to Customer No.");
              'NOITEMPLAN' : ERROR(Text014,
        ...
        if SalesCrMemoLine.FINDSET then begin
          repeat
            ...
            case CheckTriggers(TriggerMethod::Credit,CommPlanCode,SalesCrMemoLine.Type) of
              'NOCUSTPLAN' : ERROR(Text013,SalesCrMemoLine."Sell-to Customer No.");
              'NOITEMPLAN' : ERROR(Text014,
        ...
        if Customer.FINDSET then begin
          repeat
            ...
            case CheckTriggers(TriggerMethod::Credit,CommPlanCode,2) of
              'NOCUSTPLAN' : ;//no action
              'NOITEMPLAN' : ;//no action
              else begin
